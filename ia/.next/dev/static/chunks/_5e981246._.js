...
;
;
const Chat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/app/components/features/chat/index.ts [app-client] (ecmascript, next/dynamic entry, async loader)").then((mod)=>({
            default: mod.Chat
        })), {
    loadableGenerated: {
        modules: [
            "[project]/app/components/features/chat/index.ts [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false,
