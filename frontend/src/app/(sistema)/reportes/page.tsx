...
export default function ReportesPage() {
  return (
    ...
    <div className="min-h-screen bg-gray-50/50 p-4 md:p-8 space-y-6 md:space-y-8">
      <DashboardHeader subtitle="Reportes de mantenimientos" />

      {/* Header con botón de acción */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
        <div>
           <Link href="/dashboard" className="flex items-center text-gray-500 text-sm mb-2 sm:mb-0 hover:text-blue-600">
             <ArrowLeft className="w-4 h-4 mr-1" /> Volver al inicio
           </Link>
        </div>
        <button className="w-full sm:w-auto bg-[#007EA7] text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-[#005F7D] transition-colors flex items-center justify-center">
