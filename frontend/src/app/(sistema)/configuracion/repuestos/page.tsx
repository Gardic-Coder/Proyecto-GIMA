            ...
            <div className="md:p-10 overflow-hidden">
              <div className="w-full overflow-x-auto pb-4 md:pb-0">
                <div className="md:min-w-[900px]">
                  ...
                  {/* CABECERA: Modificada a grid-cols-5 y eliminada la columna "Ubicación" */}
                  ...
                  <div className="space-y-4 md:space-y-0 md:border-x md:border-b md:border-gray-100 md:rounded-b-[30px] md:overflow-hidden font-archivo">
                    ...
                    {isLoading ? (
                      ...
                      repuestos.map((repuesto) => (
                        <div
                          key={repuesto.id}
                          // TARJETA: Modificada a grid-cols-5
                          className="flex flex-col gap-3 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm md:grid md:grid-cols-5 md:items-center md:gap-0 md:p-6 md:rounded-none md:border-0 md:border-b md:border-gray-50 md:shadow-none md:last:border-0 md:hover:bg-gray-50/50 transition-colors"
                        >
                          ...
                          <div className="flex flex-col gap-3 mt-2 md:mt-0 md:contents border-t border-gray-50 pt-3 md:border-0 md:pt-0">
                            <div className="flex justify-between items-center md:contents">
                              ...
                              {/* SE ELIMINÓ EL SPAN DE LA UBICACIÓN AQUÍ */}
                              
                              <span className="text-sm font-bold text-gima-navy md:order-4">
                                <span className="md:hidden text-xs text-gray-400 font-normal mr-1">Stock:</span>
                                {repuesto.stock}
                              </span>
                            </div>

                            <div className="flex justify-end gap-2 md:justify-center md:gap-3 md:order-5 border-t border-gray-50 pt-3 md:border-0 md:pt-0">
                              <button 
